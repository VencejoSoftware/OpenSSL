...
*)
  ...
  NETSCAPE_CERT_SEQUENCE_it: function: PASN1_ITEM; cdecl = nil;
    ...
    PEM_write_bio_PKCS8_PRIV_KEY_INFO: function (p8: pPKCS8_Priv_Key_Info; bp: pBIO): Integer; cdecl = nil;
    PKCS8_PRIV_KEY_INFO_free: procedure (var a: pPKCS8_Priv_Key_Info); cdecl = nil;
  ...
  X509_STORE_CTX_init: procedure (ctx: pX509_STORE_CTX; store: pX509_STORE; X509: pX509; chain: pSTACK_OFX509);
    cdecl = nil;
...
begin
 if @X509_new = nil then
  begin
    ...
    @PEM_write_bio_PKCS8_PRIV_KEY_INFO:= LoadFunctionCLib('PEM_write_bio_PKCS8_PRIV_KEY_INFO');
    @PKCS8_PRIV_KEY_INFO_free:= LoadFunctionCLib('PKCS8_PRIV_KEY_INFO_free');
   ...
   @X509_STORE_CTX_new:= LoadFunctionCLib('X509_STORE_CTX_new');
   @X509_STORE_CTX_free:= LoadFunctionCLib('X509_STORE_CTX_free');
   @X509_STORE_CTX_init:= LoadFunctionCLib('X509_STORE_CTX_init');
  end;
end;
